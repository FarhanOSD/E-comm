...
function PlaceOrder() {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 max-h-[80vh]  border-t">
      {/* ....... Left Side ...... */}
        ...
        <div className="mt-12">
          ...
          <div className="w-full text-end mt-8">
            <button
              ...
              className="bg-slate-300 text-black px-16 py-3 text-sm"
            >
              Place Order
            </button>
          </div>
